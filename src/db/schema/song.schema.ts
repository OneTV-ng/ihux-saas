...
export const songs = table("songs", {
  ...
  flaggedBy: varchar("flagged_by", { length: 100 }).references(() => users.id, { onDelete: "set null" }),
  approvedBy: varchar("approved_by", { length: 100 }).references(() => users.id, { onDelete: "set null" }),
